    ...
    val levels: List<CurriculumLevel> = listOf(
        ...
        CurriculumLevel(
            ...
            vocabulary = listOf(
                ...
                VocabularyWord("v20", "Қағаз", "📄", "Жазуға арналған парақ.", "Қағазға сурет салдым."),
            ...
            activities = listOf(
                ...
                activity(
                    ...
                    choice("l5b2", "Оқиғаны тыңда", "Марат күшіктің ыдысына су құйды. Күшік не істейді?", "Келесі не болуы мүмкін?", "Су ішеді", "Кітап оқыды", "Су ішеді", "Ұшып кетеді", hint = "Ыдыстағы су жануар ішу үшін берілді."),
